<?php
/**
 * Plugin Name: Genesis Columns Advanced - to Bootstrap
 * Description: Adds shortcodes to easily create up to 42 different columned layouts.
 * Version: 2.0.2
 * Author: Nick Diego - modified by matt bilodeau
 * Author URI: http://www.nickdiego.com
 * Text Domain: genesis-columns-advanced-to-bootstrap
 * License: GPLv2
 *
...
class Genesis_Columns_Advanced {
	...
	public function get_shortcodes() {
		...
		$shortcodes = apply_filters( 'NEED_shortcodes', array(
			'one'			=> array( 'type' => 'column' ,'bs' => 'col-md-12 col-xs-12'),
			'one-half' 		=> array( 'type' => 'column' ,'bs' => 'col-md-6 col-xs-6'),
			'one-third' 		=> array( 'type' => 'column' ,'bs' => 'col-md-4 col-xs-4'),
			'two-thirds' 		=> array( 'type' => 'column' ,'bs' => 'col-md-8 col-xs-8'),
			'one-fourth' 		=> array( 'type' => 'column' ,'bs' => 'col-md-3 col-xs-3'),
			'two-fourths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-6 col-xs-6'),
			'three-fourths' 	=> array( 'type' => 'column' ,'bs' => 'col-md-9 col-xs-9'),
			'one-fifth' 		=> array( 'type' => 'column' ,'bs' => 'col-md-2 col-xs-2'),
			'two-fifths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-4 col-xs-5'),
			'three-fifths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-6 col-xs-7'),
			'four-fifths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-8 col-xs-10'),
			'one-sixth' 		=> array( 'type' => 'column' ,'bs' => 'col-md-2 col-xs-12'),
			'two-sixths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-4 col-xs-12'),
			'three-sixths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-6 col-xs-12'),
			'four-sixths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-8 col-xs-12'),
			'five-sixths' 		=> array( 'type' => 'column' ,'bs' => 'col-md-10 col-xs-12'),
			
			'clearfix' 			=> array( 'type' => 'utility', 'bs' => 'clearfix' ),
			'vertical-spacer' 	=> array( 'type' => 'utility', 'bs' => 'vertical-spacer'),
			'columns-container' => array( 'type' => 'utility', 'bs' => 'row' ),
		));
